#define RPI A0 // single to the raspberry pi pin 29/GPIO 5 that it should start the shutdown sequence PIN #0
...
*/
void blinkPhase(short value, bool offRed=false);
...
//    if (offRed) { digitalWrite(LED, HIGH); }
  } else {
    digitalWrite(VLED, HIGH);
//    if (offRed) { digitalWrite(LED, LOW); }
  }
}
